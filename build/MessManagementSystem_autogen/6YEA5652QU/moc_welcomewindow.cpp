...
void WelcomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WelcomeWindow::*)()>(_a, &WelcomeWindow::registerClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (WelcomeWindow::*)()>(_a, &WelcomeWindow::loginClicked, 1))
            return;
    }
}
...
// SIGNAL 0
void WelcomeWindow::registerClicked()
{
